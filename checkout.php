  ...
  <h1 class="page-heading" style="font-size: 24px;">Tiến hành thanh toán</h1>
 	<div class="row">
 		<div class="col-md-6">
 			...
 			<div class="col-md-9">
 				<input type="text" name="CustomerName" placeholder="Họ tên khách hàng" value="" class="form-control">
 				<br>
 			</div>
 			<label class="col-md-3" for="inputPhone">Điện thoại (*)</label>
 			<div class="col-md-9">
 				<input type="text" name="Phone" placeholder="Điện thoại" value="" class="form-control">
 				<br>
 			</div>
 			<label class="col-md-3" for="inputAddress">Địa chỉ (*)</label>
 			<div class="col-md-9">
 				<input type="text" name="Address" placeholder="Địa chỉ giao hàng" value="" class="form-control">
 				<br>
 			</div>
 		</div>
        <div class="col-md-6">
